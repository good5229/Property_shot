...
extension FeedbackCueAccessibility on FeedbackCue {
  String get visualLabel => switch (this) {
    ...
    FeedbackCue.sharpCollision => '뾰족 충돌',
    FeedbackCue.mysteryReveal => '미스터리 상자 개방',
    ...
    FeedbackCue.observatoryRestored => '관측소 복구',
    FeedbackCue.lighthouseRestored => '등대 복구',
    FeedbackCue.bridgeRestored => '다리 복구',
