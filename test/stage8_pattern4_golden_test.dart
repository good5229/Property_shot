...
void main() {
  ...
  for (final fixture in const [
    ...
    testWidgets('8단계 4번 직행 차단 배치 ${fixture.name}', (tester) async {
      ...
      await tester.pumpWidget(
        RepaintBoundary(
          key: const Key('stage8_pattern4_golden'),
          child: PropertyShotApp(
            initialState: level.createState(7, productRules: true),
      ...
      expect(find.text('8. 세 번 이어라'), findsOneWidget);
      expect(find.byKey(const Key('aim_area')), findsOneWidget);
      await expectLater(
        find.byKey(const Key('stage8_pattern4_golden')),
        matchesGoldenFile(
          'goldens/stage8_pattern4_blocked_${fixture.name}.png',
        ),
      );
    });
  }
