...
| `assets/icons/crate.png` | `Sprites/Crate Wood.png` in `smooth_physics_props.zip` | 섬 지도 단계 카드·레거시 아이콘 | CC0 1.0 Universal | `assets/licenses/asset_hashes.txt` |
| `assets/icons/stone_boulder.png` | `Sprites/Stone Boulder.png` in `smooth_physics_props.zip` | 섬 지도 단계 카드·레거시 아이콘 | CC0 1.0 Universal | `assets/licenses/asset_hashes.txt` |
