...
- `assets/generated/nav-helm-v1.png`, `nav-stage-map-v1.png`, `nav-replay-v1.png`, `nav-daily-challenge-v1.png`, `nav-activities-v1.png`, `hint-key-v1.png`, `hint-lantern-v1.png`: 시작·지도·리플레이·오늘의 도전·활동 묶음·힌트의 장식형 이모지와 일반 기호를 대체하는 프로젝트 전용 RGBA 삽화다. 첫 항해 단계 삽화만 내부 스타일 참조로 사용했으며 글자·로고·워터마크·제3자 이미지를 입력하지 않았다.
