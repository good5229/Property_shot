...
이 절의 최신 수치는 2026-08-03 당시 252개 통과다. 아래 표의 244개·231개와 함께 역사적 수치로만 보존하며 최신 종합 판정에는 사용하지 않는다. 2026-08-08 전체 회귀는 893개가 통과했지만 Web·iOS·Android 실기기 간 이벤트 지문 동등성은 아직 검증하지 않았다.
