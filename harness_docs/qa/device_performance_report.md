...
| Android ARM64 API 28 AVD | 1080×1920 세로 Release 실행·입력 스모크 통과 | 프레임 시간·GPU·메모리·햅틱 미측정 |
...
Android ARM64 에뮬레이터에서는 홈, 1단계, 물체 정보 팝업, 속성 옮기기 후 상태를 실제 입력으로 확인했다. 이 결과는 [android-arm64-evidence.json](../../screenshots/commercial-vertical-slice/android-arm64-evidence.json)과 캡처 4장에 보존했으며, 에뮬레이터 실행만으로 60FPS나 실기기 성능을 판정하지 않는다.
