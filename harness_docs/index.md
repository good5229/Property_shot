...
This is the lazy-load entry point for repository guidance. Read only the
...
- [Web Reference Verification](research/web_reference_verification_2026-08-03.md)
...
- [License Review](assets/license_review.md)
- [Manual Cross Review](agents/manual_cross_review_2026-08-03.md)
- [Activation Records](agents/activation_records.md)
- [Independent Reviews](agents/independent_reviews.md)
- [Proposal Scoreboard](agents/proposal_scoreboard.md)
- [Stage4 Redesign](design/stage4_causality_redesign.md)
- [Hole Flag Layering](design/hole_flag_layering_spec.md)
- [Visual Style Update](design/visual_style_update.md)
- [Stage4 Causality Validation](qa/stage4_causality_validation.md)
- [Stage4 Validation Summary](qa/stage4_validation.md)
- [Hole Flag Validation](qa/hole_flag_validation.md)
- [Copy Validation](qa/copy_validation.md)
- [Asset Validation](qa/asset_validation.md)
- [Accessibility Validation](qa/accessibility_validation.md)
- [Visual Capture Evidence](qa/visual_capture_evidence.md)
- [Commit Push Summary](final/commit_push_summary.md)
- [Goal Completion Audit](final/goal_completion_audit_2026-08-03.md)
